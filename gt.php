...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = pg_query_params($databaseConnection, 'INSERT INTO guindy_times (name, email, queries) VALUES ($1, $2, $3)', array($name, $email, $queries));
    $result = pg_query_params($databaseConnection, 'INSERT INTO gt_con (name, email, queries) VALUES ($1, $2, $3)', array($name, $email, $queries));
...
<form action="gt.php" method="post" onsubmit="redirectToComplete()">
