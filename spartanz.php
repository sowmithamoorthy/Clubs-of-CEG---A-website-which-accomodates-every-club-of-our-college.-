...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = pg_query_params($databaseConnection, 'INSERT INTO spartanz (name, email, queries) VALUES ($1, $2, $3)', array($name, $email, $queries));
    $result = pg_query_params($databaseConnection, 'INSERT INTO spartanz_con (name, email, question) VALUES ($1, $2, $3)', array($name, $email, $queries));
    if (!$result) {
...
<form action="spartanz.php" method="post" onsubmit="redirectToComplete()">
