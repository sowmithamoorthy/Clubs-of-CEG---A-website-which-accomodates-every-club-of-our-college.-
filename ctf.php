...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = pg_query_params($databaseConnection, 'INSERT INTO ctf (name, email, queries) VALUES ($1, $2, $3)', array($name, $email, $queries));
    $result = pg_query_params($databaseConnection, 'INSERT INTO ctf_con (name, email, question) VALUES ($1, $2, $3)', array($name, $email, $queries));
...
<form action="ctf.php" method="post" onsubmit="redirectToComplete()">
