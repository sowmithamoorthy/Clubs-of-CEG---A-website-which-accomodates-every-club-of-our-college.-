...
// Fetch responses for the specific student from the 'aupodium_answer' table
$query = "SELECT question, answer FROM  aupodium_answer WHERE email = $1"; // Assuming 'email' is the correct column name
